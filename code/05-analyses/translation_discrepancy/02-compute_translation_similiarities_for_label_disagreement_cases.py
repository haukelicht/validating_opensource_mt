...
input_file = data_path / 'intermediate' / 'cmp_translations_sample_label_disagreement_cases.tsv'
output_file = data_path / 'results' / 'translation_discrepancy' / 'cmp_translations_sample_label_disagreement_cases_bertscores.tsv'
...
cols = ['other_model', 'qs_id', 'lang', 'text', 'language']
